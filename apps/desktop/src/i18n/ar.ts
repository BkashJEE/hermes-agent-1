...
export const ar = defineLocale({
  ...
  settings: {
    ...
    mobilePairing: {
      title: 'تطبيق Hermes المصاحب للهاتف',
      description:
        'اقرن تطبيق iPhone المصاحب ببوابة Hermes هذه. يستخدم الهاتف الوكلاء والملفات الشخصية والجلسات والذاكرة والمهارات نفسها، ولا يشغّل وكيلاً آخر.',
      show: 'إظهار رمز الاقتران',
      retry: 'المحاولة مجدداً',
      hide: 'إخفاء الرمز',
      refresh: 'تحديث الرمز',
      scan: 'افتح Hermes على iPhone وامسح هذا الرمز.',
      expires: 'لأمانك، يُخفى الرمز بعد دقيقتين. أبقه خاصاً لأنه يمنح الوصول إلى بوابتك.',
      qrAlt: 'رمز QR لاقتران تطبيق Hermes المصاحب',
      publicUrlRequired:
        'اضبط dashboard.public_url على عنوان HTTPS خاص يصل إلى هذه البوابة، ثم حاول مجدداً. لا يمكن استخدام localhost أو HTTP العادي.',
      tokenRequired:
        'لا يستطيع هذا الاتصال إصدار رمز محلي قابل لإعادة الاستخدام للبوابة. انتقل إلى بوابة Hermes تستخدم مصادقة الرمز.',
      routeStale:
        'لم يعد عنوان الهاتف الخاص هذا يصل إلى بوابة سطح المكتب الحالية. يحدّث الإصلاح منفذ Tailscale HTTPS المطابق فقط ويُبقي مسارات Serve الأخرى.',
      refreshRoute: 'تحديث المسار الآمن',
      routeRefreshFailed: 'تعذّر على Hermes تحديث مسار Tailscale. تأكد من تثبيت Tailscale واتصاله، ثم حاول مجدداً.',
      failed: 'تعذّر على Hermes إنشاء رمز اقتران للهاتف. تحقق من اتصال البوابة وحاول مجدداً.'
    },
    gateway: {
