...
export const en: Translations = {
  ...
  hud: {
    ...
    followOn: 'Following the pointer — click to stop',
    followOff: 'Follow the pointer',
    followUnsupported: 'This desktop cannot place windows, so the HUD cannot follow the pointer',
    agent: 'Agent',
    switchAgent: 'Switch agent',
    room: 'Room',
    switchRoom: 'Talk to a room from here',
    inRoom: room => `In room ${room}`,
    leaveRoom: 'Leave room',
    openRoomInApp: 'Open in app window',
    roomEmpty: 'Nothing said here yet. Type below to start the room.',
    roomThinking: name => `${name} is replying…`,
    you: 'You',
    noAgents: 'No other agents yet',
    noRooms: 'No group chats yet',
    busyWarning: 'A turn is running — switching agents restarts the HUD and drops it',
    askTitle: 'What do you want to do with this?',
    viaShortcut: 'At the pointer',
    viaRightClick: 'Right-click',
    explain: 'Explain',
    summarize: 'Summarize',
    doIt: 'Do it',
    ask: 'Ask…',
    dismiss: 'Dismiss',
    screenAtCursor: 'Screen at pointer',
    petThinking: 'hmm…',
    petWorking: 'working…',
    petWaiting: 'your turn',
    petDone: 'done!',
    petError: 'oops'
  },
  ...
  keybinds: {
    ...
    actions: {
      ...
      'hud.toggleFollow': 'Toggle HUD follow-the-pointer',
  ...
  settings: {
    ...
    appearance: {
      ...
      themeProfileNote: _profile => 'Applied across Team Hermes — every profile uses the same desktop appearance.',
    ...
    hud: {
      followTitle: 'HUD follows the pointer',
      followDesc: 'The floating bar trails the mouse and holds still when you reach for it or type in it.',
      followUnsupported: 'Not available on native Wayland: windows cannot place themselves there.',
      petsTitle: 'Pixel pets on the HUD',
      petsDesc: 'Your agents\u2019 pets patrol the strip above the bar, react to the turn, and stop to look at your pointer.',
      petByAgentTitle: 'Pet per agent',
      petByAgentDesc: 'Which pet walks the HUD when you talk to each agent. In a room, every member\u2019s pet comes out.',
      petChoice: { hank: 'Hank', mina: 'Mina', avatar: 'Avatar badge', none: 'No pet' },
      askShortcutTitle: 'Ask about what is under the pointer',
      askShortcutDesc:
        'Global shortcut. Captures the app and a screenshot around the pointer and opens the HUD asking what to do.',
      rightClickTitle: 'Ctrl + right-click anywhere asks too',
      rightClickDesc: 'Uses a system-wide input hook. A plain right-click is never intercepted.',
      rightClickUnavailable: reason => `Needs the optional uiohook-napi module — ${reason || 'not installed'}.`,
      active: 'Shortcut is active.',
      takenBy: 'Another app already uses this shortcut — pick a different one.',
      invalidShortcut: 'Not a valid shortcut. Include at least one modifier key.'
    },
